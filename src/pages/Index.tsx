      ...
      <Card className="w-full max-w-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-xl border-white/10 shadow-2xl hover:shadow-purple-500/10 transition-all duration-300">
        <CardHeader className="text-center space-y-6 pb-8">
          ...
          <div className="space-y-2">
            ...
            <CardTitle className="text-4xl font-bold text-purple-300">
        ...
        <CardContent className="space-y-10">
          {/* Bio Section */}
          <p className="text-center text-purple-50 max-w-xl mx-auto leading-relaxed font-medium">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="tel:0754274528" 
                className="flex items-center gap-3 text-purple-100 hover:text-purple-200 transition-colors group"
              >
            ...
            <div className="flex justify-center gap-8 pt-6">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-purple-200 hover:text-purple-100 transition-all duration-300 hover:scale-110"
              >
