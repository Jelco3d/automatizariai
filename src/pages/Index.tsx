    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1A1F2C] via-[#2C1F3C] to-[#1A1F2C] flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-[#1A1F2C] border-purple-500/50">
        <CardHeader className="text-center space-y-6 pb-8">
          <div className="mx-auto bg-purple-500/20 rounded-full p-8 w-fit">
          ...
          <div className="space-y-2">
            ...
            <CardTitle className="text-4xl font-bold text-purple-200">
              AI Automation Expert
            </CardTitle>
          </div>
          <CardDescription className="text-lg text-purple-100 max-w-lg mx-auto leading-relaxed font-medium">
        ...
        <CardContent className="space-y-10">
          {/* Bio Section */}
          <p className="text-center text-purple-100 max-w-xl mx-auto leading-relaxed font-medium">
          ...
          <div className="grid gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 bg-purple-900/30 p-4 rounded-lg border border-purple-500">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a 
                href="tel:0754274528" 
                className="flex items-center gap-3 text-purple-100 hover:text-purple-300 transition-colors"
              >
          ...
          <div className="text-center pt-6">
            <Button 
              size="lg" 
              className="bg-purple-500 text-white hover:bg-purple-600 transition-colors text-lg px-8 py-6 h-auto"
            >
