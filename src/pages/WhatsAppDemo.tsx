...
const WhatsAppDemo = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-[#1A1F2C] via-[#2C1F3C] to-[#1A1F2C] relative overflow-hidden">
      ...
      <section className="container mx-auto px-4 md:py-24 text-center relative py-0">
        <h1 className="sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-300 mb-6 leading-tight text-center text-xl">Oprește Pierderea Pacienților Din Cauza Răspunsurilor Întârziate pe WhatsApp</h1>
