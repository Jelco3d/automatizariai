  ...
  const form = useForm<InvoiceTemplateFormData>({
    ...
    defaultValues: template
      ? {
          ...
          company_city: template.company_city || 'Sat Mosnita Noua',
          bank_name: template.bank_name || 'Banca Transilvania',
          bank_account: template.bank_account || 'RO30BTRLRONCRT0CP5986701',
      ...
      : {
          ...
          company_city: 'Sat Mosnita Noua',
          bank_name: 'Banca Transilvania',
          bank_account: 'RO30BTRLRONCRT0CP5986701',
          logo_url: '',
