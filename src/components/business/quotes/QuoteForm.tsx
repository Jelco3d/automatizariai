  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <Card className="bg-[#1A1F2C] border-purple-500/20 p-4 md:p-6">
        <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Informații Client</h3>
      ...
      <Card className="bg-[#1A1F2C] border-purple-500/20 p-4 md:p-6">
        <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Detalii Ofertă</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label className="text-white">Data emiterii *</Label>
            <Input
              type="date"
              {...register('issue_date', {
          ...
          <div>
            <Label className="text-white">Valabilă până la *</Label>
            <Input
              type="date"
      ...
      <Card className="bg-[#1A1F2C] border-purple-500/20 p-4 md:p-6">
        <h3 className="text-lg md:text-xl font-semibold text-white mb-4">Termeni și Notițe</h3>
        <div className="space-y-4">
          <div>
            <Label className="text-white">Termeni și condiții</Label>
            <Textarea
              {...register('terms')}
          ...
          <div>
            <Label className="text-white">Notițe</Label>
            <Textarea
              {...register('notes')}
      ...
      <div className="flex gap-3 justify-end">
        ...
        >
          {isSubmitting ? 'Se salvează...' : initialData ? 'Actualizează Oferta' : 'Creează Oferta'}
        </Button>
      </div>
    </form>
  );
