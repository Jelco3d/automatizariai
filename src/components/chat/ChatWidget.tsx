...
export const ChatWidget = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Card className={`w-96 md:w-80 bg-[#1A1F2C]/95 backdrop-blur-xl border-blue-500/50 shadow-2xl transition-all duration-300 ${
        isMinimized ? "h-14" : "h-[500px] md:h-96"
      }`}>
        ...
        {!isMinimized && (
          <>
            <CardContent className="p-0 h-80 md:h-64 overflow-hidden">
