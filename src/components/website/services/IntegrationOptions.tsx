  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {techs.map((tech, i) => (
          <div key={i} className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] hover:border-yellow-400/30 p-6 rounded-lg flex items-center justify-center transition-all hover:bg-white/[0.06]">
